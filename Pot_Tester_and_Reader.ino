...
//#include <MultiMover_Sys.h> Update program via Libary?
int Debug = true;
...
void setup() {
  ...
  //Serial Print Line Welcome Page
...
void loop() {
  ...
  lcd.setCursor(0,1); lcd.print("Sensor 2 : "); lcd.setCursor(11,1); lcd.print(voltageB); 
  lcd.setCursor(0,2); lcd.print("Sensor 3 : "); lcd.setCursor(11,2); lcd.print(voltageC);
  lcd.setCursor(0,3); lcd.print("Sensor 4 : "); lcd.setCursor(11,3); lcd.print(voltageD);
